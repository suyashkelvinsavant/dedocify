          ...
          <div className="row h-100 align-items-center py-5">
            <div className="col-lg-6">
              ...
              <p className="lead text-muted mb-0">
                ...
                developed using React.js, MetaMask wallet Authentication and IPFS. Our Team developed world's first health report encrypted file locker in terms of WEB3.0
              </p>
