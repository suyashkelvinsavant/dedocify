    ...
    return(
      ...
      <Card className="HomePage__container" style={{
        ...
        <Card.Text className="text-muted">
          We provide you safe place for your health reports using IPFS, You can also DOWNLOAD, SHARE and Manage your data safely & easily.
        </Card.Text>
      </Card>
            ...
            <div className='wrapper'>
                <div className='carousel'>
                    ...
                    <div className='carousel__item'>
                        <div className='carousel__item-head'>
                            <Card.Img
                                src="https://icommunity.io/wp-content/uploads/2020/08/IPFS.jpg"
                                alt="ipfs 2 image"
                            />
                        </div>
                        <div className='carousel__item-body'>
